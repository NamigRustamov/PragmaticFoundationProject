...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.label.setText(QCoreApplication.translate("Widget", u"Istifadeci adi", None))
        self.label_2.setText(QCoreApplication.translate("Widget", u"Parol", None))
        self.label_3.setText(QCoreApplication.translate("Widget", u"Daxil olmaq ucun qeydiyyatdan kecin", None))
        self.label_4.setText(QCoreApplication.translate("Widget", u"Ambara Xos Gelmisiniz", None))
    # retranslateUi
